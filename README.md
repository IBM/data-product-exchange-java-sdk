# Data Product Hub Java SDK Version 3.0.0
...
| -------------------------------------------------------------- | ----------------------- |
| [Data Product Hub](https://cloud.ibm.com/apidocs/dataproducts) | com.ibm.cloud:dph:3.0.0 |
...
```gradle
compile 'com.ibm.cloud:dph:3.0.0'
```
