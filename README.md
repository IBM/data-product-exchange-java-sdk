# Data Product Hub Java SDK Version 2.0.0
...
| -------------------------------------------------------------- | ----------------------- |
| [Data Product Hub](https://cloud.ibm.com/apidocs/dataproducts) | com.ibm.cloud:dph:2.0.0 |
...
```gradle
compile 'com.ibm.cloud:dph:2.0.0'
```
