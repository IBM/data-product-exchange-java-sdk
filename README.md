# Data Product Hub Java SDK Version 1.0.0
...
--- | ---
[Data Product Hub](https://cloud.ibm.com/apidocs/dataproducts) | com.ibm.cloud:dph:1.0.0
...
### Gradle
```gradle
compile 'com.ibm.cloud:dph:1.0.1'
```
