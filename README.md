# Data Product Hub Java SDK Version 1.1.2
...
| -------------------------------------------------------------- | ----------------------- |
| [Data Product Hub](https://cloud.ibm.com/apidocs/dataproducts) | com.ibm.cloud:dph:1.1.2 |
...
```gradle
compile 'com.ibm.cloud:dph:1.1.2'
```
