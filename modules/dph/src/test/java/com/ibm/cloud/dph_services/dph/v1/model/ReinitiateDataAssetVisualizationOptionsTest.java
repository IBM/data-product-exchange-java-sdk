...
/**
 * Unit test class for the ReinitiateDataAssetVisualizationOptions model.
 */
public class ReinitiateDataAssetVisualizationOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testReinitiateDataAssetVisualizationOptions() throws Throwable {
    ...
    ReinitiateDataAssetVisualizationOptions reinitiateDataAssetVisualizationOptionsModel = new ReinitiateDataAssetVisualizationOptions.Builder()
      ...
      .build();
    assertEquals(reinitiateDataAssetVisualizationOptionsModel.assets(), java.util.Arrays.asList(dataAssetRelationshipModel));
  }
}