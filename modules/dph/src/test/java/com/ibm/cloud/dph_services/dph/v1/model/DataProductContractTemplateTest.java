...
public class DataProductContractTemplateTest {
  ...
  public void testDataProductContractTemplate() throws Throwable {
    ...
    assertEquals(dataProductContractTemplateModel.creatorId(), "IBMid-123456ABC");
    assertEquals(dataProductContractTemplateModel.createdAt(), DateUtils.parseAsDateTime("2025-06-26T12:30:20.000Z"));
    ...
    assertEquals(dataProductContractTemplateModelNew.creatorId(), "IBMid-123456ABC");
    assertEquals(dataProductContractTemplateModelNew.createdAt(), DateUtils.parseAsDateTime("2025-06-26T12:30:20.000Z"));
