...
public class ContractSchemaTest {
  ...
  public void testContractSchema() throws Throwable {
    ...
    assertEquals(contractSchemaModelNew.id(), "schema-001");
    assertEquals(contractSchemaModelNew.assetId(), "2b0bf220-079c-41ee-be56-0242ac120002");
    assertEquals(contractSchemaModelNew.connectionId(), "2b0bf220-079c-41ee-be56-0242ac120002");
    assertEquals(contractSchemaModelNew.name(), "testString");
    assertEquals(contractSchemaModelNew.type(), "table");
    ...
    assertEquals(contractSchemaModelNew.businessName(), "testString");
    assertEquals(contractSchemaModelNew.logicalType(), "testString");
    assertEquals(contractSchemaModelNew.physicalName(), "testString");
    assertEquals(contractSchemaModelNew.dataGranularityDescription(), "testString");
    assertEquals(contractSchemaModelNew.physicalSchema(), "testString");
    assertEquals(contractSchemaModelNew.server(), "testString");
  }
