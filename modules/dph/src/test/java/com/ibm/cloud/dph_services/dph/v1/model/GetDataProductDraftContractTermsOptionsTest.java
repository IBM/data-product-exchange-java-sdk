...
/**
 * Unit test class for the GetDataProductDraftContractTermsOptions model.
 */
public class GetDataProductDraftContractTermsOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetDataProductDraftContractTermsOptions() throws Throwable {
  ...
  public void testGetDataProductDraftContractTermsOptionsError() throws Throwable {
    new GetDataProductDraftContractTermsOptions.Builder().build();
  }
