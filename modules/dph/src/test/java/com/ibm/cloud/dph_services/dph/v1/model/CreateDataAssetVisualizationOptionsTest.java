...
/**
 * Unit test class for the CreateDataAssetVisualizationOptions model.
 */
public class CreateDataAssetVisualizationOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testCreateDataAssetVisualizationOptions() throws Throwable {
    ...
    CreateDataAssetVisualizationOptions createDataAssetVisualizationOptionsModel = new CreateDataAssetVisualizationOptions.Builder()
      ...
      .build();
    assertEquals(createDataAssetVisualizationOptionsModel.assets(), java.util.Arrays.asList(dataAssetRelationshipModel));
  }
}