...
/**
 * Unit test class for the DataProductVersionCollection model.
 */
public class DataProductVersionCollectionTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testDataProductVersionCollection() throws Throwable {
    DataProductVersionCollection dataProductVersionCollectionModel = new DataProductVersionCollection();
    assertNull(dataProductVersionCollectionModel.getLimit());
    assertNull(dataProductVersionCollectionModel.getFirst());
    assertNull(dataProductVersionCollectionModel.getNext());
    assertNull(dataProductVersionCollectionModel.getTotalResults());
    assertNull(dataProductVersionCollectionModel.getDataProductVersions());
  }
}