...
/**
 * Unit test class for the DataProductDraftSummary model.
 */
public class DataProductDraftSummaryTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testDataProductDraftSummary() throws Throwable {
    DataProductDraftSummary dataProductDraftSummaryModel = new DataProductDraftSummary();
    assertNull(dataProductDraftSummaryModel.getVersion());
    assertNull(dataProductDraftSummaryModel.getState());
    assertNull(dataProductDraftSummaryModel.getDataProduct());
    assertNull(dataProductDraftSummaryModel.getName());
    assertNull(dataProductDraftSummaryModel.getDescription());
    assertNull(dataProductDraftSummaryModel.getTags());
    assertNull(dataProductDraftSummaryModel.getUseCases());
    assertNull(dataProductDraftSummaryModel.getTypes());
    assertNull(dataProductDraftSummaryModel.getContractTerms());
    assertNull(dataProductDraftSummaryModel.getDomain());
    assertNull(dataProductDraftSummaryModel.getPartsOut());
    assertNull(dataProductDraftSummaryModel.getWorkflows());
    assertNull(dataProductDraftSummaryModel.isDataviewEnabled());
    assertNull(dataProductDraftSummaryModel.getComments());
    assertNull(dataProductDraftSummaryModel.getAccessControl());
    assertNull(dataProductDraftSummaryModel.getLastUpdatedAt());
    assertNull(dataProductDraftSummaryModel.getCreatedDate());
    assertNull(dataProductDraftSummaryModel.getSubContainer());
    assertNull(dataProductDraftSummaryModel.isIsRestricted());
    assertNull(dataProductDraftSummaryModel.getId());
    assertNull(dataProductDraftSummaryModel.getAsset());
  }
}