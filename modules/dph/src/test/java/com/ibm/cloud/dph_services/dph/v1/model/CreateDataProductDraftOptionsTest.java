...
public class CreateDataProductDraftOptionsTest {
  ...
  public void testCreateDataProductDraftOptions() throws Throwable {
    ...
    assertEquals(createDataProductDraftOptionsModel.createdDate(), DateUtils.parseAsDateTime("2019-01-01T12:00:00.000Z"));
    assertEquals(createDataProductDraftOptionsModel.subContainer(), containerIdentityModel);
