...
/**
 * Unit test class for the ContractSchemaRelationship model.
 */
public class ContractSchemaRelationshipTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testContractSchemaRelationship() throws Throwable {
    ...
    String json = TestUtilities.serialize(contractSchemaRelationshipModel);

    ContractSchemaRelationship contractSchemaRelationshipModelNew = TestUtilities.deserialize(json, ContractSchemaRelationship.class);
    assertTrue(contractSchemaRelationshipModelNew instanceof ContractSchemaRelationship);
    assertEquals(contractSchemaRelationshipModelNew.type(), "foreignKey");
  }
}