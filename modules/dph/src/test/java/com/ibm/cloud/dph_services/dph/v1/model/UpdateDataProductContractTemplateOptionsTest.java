...
/**
 * Unit test class for the UpdateDataProductContractTemplateOptions model.
 */
public class UpdateDataProductContractTemplateOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testUpdateDataProductContractTemplateOptions() throws Throwable {
    ...
    UpdateDataProductContractTemplateOptions updateDataProductContractTemplateOptionsModel = new UpdateDataProductContractTemplateOptions.Builder()
      ...
      .build();
    assertEquals(updateDataProductContractTemplateOptionsModel.contractTemplateId(), "testString");
    assertEquals(updateDataProductContractTemplateOptionsModel.containerId(), "testString");
    assertEquals(updateDataProductContractTemplateOptionsModel.jsonPatchInstructions(), java.util.Arrays.asList(jsonPatchOperationModel));
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testUpdateDataProductContractTemplateOptionsError() throws Throwable {
    new UpdateDataProductContractTemplateOptions.Builder().build();
  }
