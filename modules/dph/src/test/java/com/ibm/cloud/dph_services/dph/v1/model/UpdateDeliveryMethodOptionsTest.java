...
/**
 * Unit test class for the UpdateDeliveryMethodOptions model.
 */
public class UpdateDeliveryMethodOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testUpdateDeliveryMethodOptions() throws Throwable {
    ...
    UpdateDeliveryMethodOptions updateDeliveryMethodOptionsModel = new UpdateDeliveryMethodOptions.Builder()
      ...
      .build();
    assertEquals(updateDeliveryMethodOptionsModel.catalogId(), "testString");
    assertEquals(updateDeliveryMethodOptionsModel.deliveryMethodId(), "testString");
    assertEquals(updateDeliveryMethodOptionsModel.jsonPatchOperation(), java.util.Arrays.asList(jsonPatchOperationModel));
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testUpdateDeliveryMethodOptionsError() throws Throwable {
    new UpdateDeliveryMethodOptions.Builder().build();
  }
