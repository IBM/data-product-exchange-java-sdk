...
/**
 * Unit test class for the ContractTerms model.
 */
public class ContractTermsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testContractTerms() throws Throwable {
    ...
    String json = TestUtilities.serialize(contractTermsModel);

    ContractTerms contractTermsModelNew = TestUtilities.deserialize(json, ContractTerms.class);
    assertTrue(contractTermsModelNew instanceof ContractTerms);
    assertEquals(contractTermsModelNew.asset().toString(), assetReferenceModel.toString());
    assertEquals(contractTermsModelNew.id(), "testString");
    assertEquals(contractTermsModelNew.errorMsg(), "testString");
    assertEquals(contractTermsModelNew.overview().toString(), overviewModel.toString());
    assertEquals(contractTermsModelNew.description().toString(), descriptionModel.toString());
    assertEquals(contractTermsModelNew.team().toString(), contractTermsTeamModel.toString());
    assertEquals(contractTermsModelNew.price().toString(), pricingModel.toString());
    assertEquals(contractTermsModelNew.sla().toString(), contractTemplateSlaModel.toString());
    assertEquals(contractTermsModelNew.contractTest().toString(), contractTestModel.toString());
  }
}