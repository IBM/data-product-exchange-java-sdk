...
/**
 * Unit test class for the DeliveryMethodPropertiesModel model.
 */
public class DeliveryMethodPropertiesModelTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testDeliveryMethodPropertiesModel() throws Throwable {
    ...
    String json = TestUtilities.serialize(deliveryMethodPropertiesModelModel);

    DeliveryMethodPropertiesModel deliveryMethodPropertiesModelModelNew = TestUtilities.deserialize(json, DeliveryMethodPropertiesModel.class);
    assertTrue(deliveryMethodPropertiesModelModelNew instanceof DeliveryMethodPropertiesModel);
    assertEquals(deliveryMethodPropertiesModelModelNew.producerInput().toString(), producerInputModelModel.toString());
  }
}