...
public class DataProductVersionPrototypeTest {
  ...
  public void testDataProductVersionPrototype() throws Throwable {
    ...
    assertEquals(dataProductVersionPrototypeModelNew.asset().toString(), assetPrototypeModel.toString());
    assertEquals(dataProductVersionPrototypeModelNew.domain().toString(), domainModel.toString());
    assertEquals(dataProductVersionPrototypeModelNew.workflows().toString(), dataProductWorkflowsModel.toString());
  }
