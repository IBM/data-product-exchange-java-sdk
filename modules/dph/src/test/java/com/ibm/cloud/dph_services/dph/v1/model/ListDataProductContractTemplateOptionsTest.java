...
/**
 * Unit test class for the ListDataProductContractTemplateOptions model.
 */
public class ListDataProductContractTemplateOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testListDataProductContractTemplateOptions() throws Throwable {
