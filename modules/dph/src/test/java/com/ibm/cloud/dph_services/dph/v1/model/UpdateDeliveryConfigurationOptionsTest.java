...
/**
 * Unit test class for the UpdateDeliveryConfigurationOptions model.
 */
public class UpdateDeliveryConfigurationOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testUpdateDeliveryConfigurationOptions() throws Throwable {
    ...
    UpdateDeliveryConfigurationOptions updateDeliveryConfigurationOptionsModel = new UpdateDeliveryConfigurationOptions.Builder()
      ...
      .build();
    assertEquals(updateDeliveryConfigurationOptionsModel.containerId(), "testString");
    assertEquals(updateDeliveryConfigurationOptionsModel.jsonPatchOperation(), java.util.Arrays.asList(jsonPatchOperationModel));
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testUpdateDeliveryConfigurationOptionsError() throws Throwable {
    new UpdateDeliveryConfigurationOptions.Builder().build();
  }
