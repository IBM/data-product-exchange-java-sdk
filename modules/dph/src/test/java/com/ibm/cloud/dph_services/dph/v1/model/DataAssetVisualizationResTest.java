...
/**
 * Unit test class for the DataAssetVisualizationRes model.
 */
public class DataAssetVisualizationResTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testDataAssetVisualizationRes() throws Throwable {
    DataAssetVisualizationRes dataAssetVisualizationResModel = new DataAssetVisualizationRes();
    assertNull(dataAssetVisualizationResModel.getResults());
  }
}