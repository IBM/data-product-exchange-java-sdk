...
public class CreateDataProductOptionsTest {
  ...
  public void testCreateDataProductOptions() throws Throwable {
    ...
    CreateDataProductOptions createDataProductOptionsModel = new CreateDataProductOptions.Builder()
      ...
      .start("testString")
      .build();
    assertEquals(createDataProductOptionsModel.drafts(), java.util.Arrays.asList(dataProductDraftPrototypeModel));
    assertEquals(createDataProductOptionsModel.limit(), Long.valueOf("200"));
    assertEquals(createDataProductOptionsModel.start(), "testString");
  }
