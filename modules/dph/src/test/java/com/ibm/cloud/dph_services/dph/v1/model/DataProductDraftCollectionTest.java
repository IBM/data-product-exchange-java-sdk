...
/**
 * Unit test class for the DataProductDraftCollection model.
 */
public class DataProductDraftCollectionTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testDataProductDraftCollection() throws Throwable {
    DataProductDraftCollection dataProductDraftCollectionModel = new DataProductDraftCollection();
    assertNull(dataProductDraftCollectionModel.getLimit());
    assertNull(dataProductDraftCollectionModel.getFirst());
    assertNull(dataProductDraftCollectionModel.getNext());
    assertNull(dataProductDraftCollectionModel.getTotalResults());
    assertNull(dataProductDraftCollectionModel.getDrafts());
  }
}