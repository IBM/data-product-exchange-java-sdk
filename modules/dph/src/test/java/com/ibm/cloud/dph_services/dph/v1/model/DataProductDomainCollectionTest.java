...
/**
 * Unit test class for the DataProductDomainCollection model.
 */
public class DataProductDomainCollectionTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testDataProductDomainCollection() throws Throwable {
    DataProductDomainCollection dataProductDomainCollectionModel = new DataProductDomainCollection();
    assertNull(dataProductDomainCollectionModel.getDomains());
  }
}