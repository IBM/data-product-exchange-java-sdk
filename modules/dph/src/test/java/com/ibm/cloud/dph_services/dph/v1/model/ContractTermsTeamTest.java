...
/**
 * Unit test class for the ContractTermsTeam model.
 */
public class ContractTermsTeamTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testContractTermsTeam() throws Throwable {
    ...
    String json = TestUtilities.serialize(contractTermsTeamModel);

    ContractTermsTeam contractTermsTeamModelNew = TestUtilities.deserialize(json, ContractTermsTeam.class);
    assertTrue(contractTermsTeamModelNew instanceof ContractTermsTeam);
    assertEquals(contractTermsTeamModelNew.id(), "team-001");
    assertEquals(contractTermsTeamModelNew.name(), "Data Governance Team");
    assertEquals(contractTermsTeamModelNew.description(), "Team responsible for data governance and quality");
  }
}