...
/**
 * Unit test class for the DataProductContractTemplateCollection model.
 */
public class DataProductContractTemplateCollectionTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testDataProductContractTemplateCollection() throws Throwable {
    DataProductContractTemplateCollection dataProductContractTemplateCollectionModel = new DataProductContractTemplateCollection();
    assertNull(dataProductContractTemplateCollectionModel.getContractTemplates());
  }
}