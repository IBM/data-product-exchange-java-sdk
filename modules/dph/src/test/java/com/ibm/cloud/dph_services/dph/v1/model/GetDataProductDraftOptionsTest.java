...
/**
 * Unit test class for the GetDataProductDraftOptions model.
 */
public class GetDataProductDraftOptionsTest {
  ...
  public void testGetDataProductDraftOptionsError() throws Throwable {
    new GetDataProductDraftOptions.Builder().build();
  }
