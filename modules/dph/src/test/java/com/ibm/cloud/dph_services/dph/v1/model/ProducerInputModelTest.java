...
/**
 * Unit test class for the ProducerInputModel model.
 */
public class ProducerInputModelTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testProducerInputModel() throws Throwable {
    ...
    String json = TestUtilities.serialize(producerInputModelModel);

    ProducerInputModel producerInputModelModelNew = TestUtilities.deserialize(json, ProducerInputModel.class);
    assertTrue(producerInputModelModelNew instanceof ProducerInputModel);
    assertEquals(producerInputModelModelNew.engineDetails().toString(), engineDetailsModelModel.toString());
  }
}