...
/**
 * Unit test class for the UpdateDataProductDomainOptions model.
 */
public class UpdateDataProductDomainOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testUpdateDataProductDomainOptions() throws Throwable {
    ...
    UpdateDataProductDomainOptions updateDataProductDomainOptionsModel = new UpdateDataProductDomainOptions.Builder()
      ...
      .build();
    assertEquals(updateDataProductDomainOptionsModel.domainId(), "testString");
    assertEquals(updateDataProductDomainOptionsModel.containerId(), "testString");
    assertEquals(updateDataProductDomainOptionsModel.jsonPatchInstructions(), java.util.Arrays.asList(jsonPatchOperationModel));
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testUpdateDataProductDomainOptionsError() throws Throwable {
    new UpdateDataProductDomainOptions.Builder().build();
  }
