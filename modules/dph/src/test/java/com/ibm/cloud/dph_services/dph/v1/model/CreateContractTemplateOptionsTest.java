...
/**
 * Unit test class for the CreateContractTemplateOptions model.
 */
public class CreateContractTemplateOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testCreateContractTemplateOptions() throws Throwable {
    ...
    CreateContractTemplateOptions createContractTemplateOptionsModel = new CreateContractTemplateOptions.Builder()
      ...
      .creatorId("IBMid-123456ABC")
      .createdAt(DateUtils.parseAsDateTime("2025-06-26T12:30:20.000Z"))
      ...
      .build();
    assertEquals(createContractTemplateOptionsModel.container(), containerReferenceModel);
    assertEquals(createContractTemplateOptionsModel.id(), "20aa7c97-cfcc-4d16-ae76-2ca1847ce733");
    assertEquals(createContractTemplateOptionsModel.creatorId(), "IBMid-123456ABC");
    assertEquals(createContractTemplateOptionsModel.createdAt(), DateUtils.parseAsDateTime("2025-06-26T12:30:20.000Z"));
    assertEquals(createContractTemplateOptionsModel.name(), "Sample Data Contract Template");
    assertEquals(createContractTemplateOptionsModel.error(), errorMessageModel);
    assertEquals(createContractTemplateOptionsModel.contractTerms(), contractTermsModel);
    assertEquals(createContractTemplateOptionsModel.containerId(), "testString");
    assertEquals(createContractTemplateOptionsModel.contractTemplateName(), "testString");
    assertEquals(createContractTemplateOptionsModel.contractTemplateStatus(), "testString");
    assertEquals(createContractTemplateOptionsModel.domainIds(), "testString");
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testCreateContractTemplateOptionsError() throws Throwable {
    new CreateContractTemplateOptions.Builder().build();
  }
