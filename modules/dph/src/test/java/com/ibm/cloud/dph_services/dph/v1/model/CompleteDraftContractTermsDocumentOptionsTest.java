...
/**
 * Unit test class for the CompleteDraftContractTermsDocumentOptions model.
 */
public class CompleteDraftContractTermsDocumentOptionsTest {
  ...
  public void testCompleteDraftContractTermsDocumentOptionsError() throws Throwable {
    new CompleteDraftContractTermsDocumentOptions.Builder().build();
  }
