...
public class DeleteDraftContractTermsDocumentOptions extends GenericModel {
  ...
  public static class Builder {
    ...
    /**
     * Instantiates a new Builder from an existing DeleteDraftContractTermsDocumentOptions instance.
     *
     * @param deleteDraftContractTermsDocumentOptions the instance to initialize the Builder with
     */
    ...
    /**
     * Builds a DeleteDraftContractTermsDocumentOptions.
     *
     * @return the new DeleteDraftContractTermsDocumentOptions instance
     */
     ...
     *
     * @param dataProductId the dataProductId
     * @return the DeleteDraftContractTermsDocumentOptions builder
     */
   ...
   * New builder.
   *
   * @return a DeleteDraftContractTermsDocumentOptions builder
   */
