...
package com.ibm.cloud.dpx_services.common;
...
public class SdkCommon {
    ...
    private static String parentArtifactId = "dpx-services";
     ...
     * @return a string containing the name (e.g. "dph-services-java-sdk")
     */
     ...
     */
    public static Map<String, String> getSdkHeaders(String serviceName, String version, String methodName) {
