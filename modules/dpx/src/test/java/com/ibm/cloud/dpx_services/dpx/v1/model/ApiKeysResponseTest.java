...
/**
 * Unit test class for the ApiKeysResponse model.
 */
public class ApiKeysResponseTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testApiKeysResponse() throws Throwable {
    ApiKeysResponse apiKeysResponseModel = new ApiKeysResponse();
    assertNull(apiKeysResponseModel.getContainer());
  }
}