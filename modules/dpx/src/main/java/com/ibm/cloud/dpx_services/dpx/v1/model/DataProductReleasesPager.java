...
public class DataProductReleasesPager {
   ...
   * @param client the Dpx instance to be used to invoke the "listDataProductReleases" method
   * @param options the ListDataProductReleasesOptions instance to be used to invoke the "listDataProductReleases" method
   */
  public DataProductReleasesPager(Dpx client, ListDataProductReleasesOptions options) {
   ...
   * @return a List&lt;DataProductVersionSummary&gt; containing all results returned by the "listDataProductReleases" method
   */
