 ...
 */
public class DataProductsPager {
  ...
  protected ListDataProductsOptions options;
  protected DataProductExchangeApiService client;
  protected PageContext pageContext;

  // Hide the default ctor.
  protected DataProductsPager() { }

  /**
   * Constructs a new DataProductsPager instance with the specified client and options model instance.
   * @param client the DataProductExchangeApiService instance to be used to invoke the "listDataProducts" method
   * @param options the ListDataProductsOptions instance to be used to invoke the "listDataProducts" method
   */
  public DataProductsPager(DataProductExchangeApiService client, ListDataProductsOptions options) {
  ...
  public List<DataProduct> getNext() {
    ...
    ListDataProductsOptions.Builder builder = this.options.newBuilder();
