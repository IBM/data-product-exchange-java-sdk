...
/**
 * Unit test class for the DeliveryResource model.
 */
public class DeliveryResourceTest {
  ...
  @Test
  public void testDeliveryResource() throws Throwable {
    DeliveryResource deliveryResourceModel = new DeliveryResource();
    assertNull(deliveryResourceModel.getStatus());
    assertNull(deliveryResourceModel.getHref());
  }
}