...
/**
 * Unit test class for the DeleteDataProductVersionOptions model.
 */
public class DeleteDataProductVersionOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testDeleteDataProductVersionOptions() throws Throwable {
    DeleteDataProductVersionOptions deleteDataProductVersionOptionsModel = new DeleteDataProductVersionOptions.Builder()
      .id("testString")
      .build();
    assertEquals(deleteDataProductVersionOptionsModel.id(), "testString");
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testDeleteDataProductVersionOptionsError() throws Throwable {
    new DeleteDataProductVersionOptions.Builder().build();
  }
