...
/**
 * Unit test class for the ErrorModel model.
 */
public class ErrorModelTest {
  ...
  @Test
  public void testErrorModel() throws Throwable {
    ErrorModel errorModelModel = new ErrorModel();
    assertNull(errorModelModel.getCode());
    assertNull(errorModelModel.getTarget());
    assertNull(errorModelModel.getMessage());
    assertNull(errorModelModel.getMoreInfo());
  }
}