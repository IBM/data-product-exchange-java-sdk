...
/**
 * Unit test class for the OrderReference model.
 */
public class OrderReferenceTest {
  ...
  @Test
  public void testOrderReference() throws Throwable {
    ...
    String json = TestUtilities.serialize(orderReferenceModel);

    OrderReference orderReferenceModelNew = TestUtilities.deserialize(json, OrderReference.class);
    assertTrue(orderReferenceModelNew instanceof OrderReference);
    assertEquals(orderReferenceModelNew.id(), "2b0bf220-079c-11ee-be56-0242ac120002");
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testOrderReferenceError() throws Throwable {
    new OrderReference.Builder().build();
  }
