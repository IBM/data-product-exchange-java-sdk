...
/**
 * Unit test class for the UpdateDataProductVersionOptions model.
 */
public class UpdateDataProductVersionOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testUpdateDataProductVersionOptions() throws Throwable {
    ...
    UpdateDataProductVersionOptions updateDataProductVersionOptionsModel = new UpdateDataProductVersionOptions.Builder()
      ...
      .build();
    assertEquals(updateDataProductVersionOptionsModel.id(), "testString");
    assertEquals(updateDataProductVersionOptionsModel.jsonPatchInstructions(), java.util.Arrays.asList(jsonPatchOperationModel));
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testUpdateDataProductVersionOptionsError() throws Throwable {
    new UpdateDataProductVersionOptions.Builder().build();
  }
