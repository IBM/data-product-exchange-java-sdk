...
/**
 * Unit test class for the GetDataProductVersionOptions model.
 */
public class GetDataProductVersionOptionsTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testGetDataProductVersionOptions() throws Throwable {
    GetDataProductVersionOptions getDataProductVersionOptionsModel = new GetDataProductVersionOptions.Builder()
      .id("testString")
      .build();
    assertEquals(getDataProductVersionOptionsModel.id(), "testString");
  }

  @Test(expectedExceptions = IllegalArgumentException.class)
  public void testGetDataProductVersionOptionsError() throws Throwable {
    new GetDataProductVersionOptions.Builder().build();
  }
