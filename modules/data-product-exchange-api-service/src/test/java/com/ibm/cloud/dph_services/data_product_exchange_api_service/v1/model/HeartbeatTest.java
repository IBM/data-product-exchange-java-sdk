...
import com.ibm.cloud.dph_services.data_product_exchange_api_service.v1.model.Heartbeat;
...
/**
 * Unit test class for the Heartbeat model.
 */
public class HeartbeatTest {
  ...
  public void testHeartbeat() throws Throwable {
    Heartbeat heartbeatModel = new Heartbeat();
    assertNull(heartbeatModel.getVersion());
  }
}