...
/**
 * Unit test class for the InitializeResource model.
 */
public class InitializeResourceTest {
  final HashMap<String, InputStream> mockStreamMap = TestUtilities.createMockStreamMap();
  final List<FileWithMetadata> mockListFileWithMetadata = TestUtilities.creatMockListFileWithMetadata();

  @Test
  public void testInitializeResource() throws Throwable {
    InitializeResource initializeResourceModel = new InitializeResource();
    assertNull(initializeResourceModel.getContainer());
    assertNull(initializeResourceModel.getHref());
    assertNull(initializeResourceModel.getStatus());
    assertNull(initializeResourceModel.getTrace());
    assertNull(initializeResourceModel.getErrors());
